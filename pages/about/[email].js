...
const About = () => {
    ...
    if (loading) {
        ...
        const { avatar, name, location, college } = user;
        return (
                ...
                <div className="relative flex flex-col justify-center items-center gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <h3 className="flex justify-center items-center text-content/70 text-center">
                            ...
                            {college ? college : "To add education click edit details"}
                        </h3>
                    </div>
                    ...
                    {!avatar || !name || !location || !college ? <Button color="red">Edit Details</Button> : ""}
                </div>
            </Main>
        );
    }
